...
public class K_PerceptibleAndExtinguishablePolygon extends K_ViewerLayer {
	...
	public void paint(Graphics2D g2, K_ScreenTransform kst, AURWorldGraph wsg, AURAreaGraph selected_ag) {
		...
		Polygon polygon = selected_ag.getBuilding().getPerceptibleAndExtinguishableAreaPolygon();
		
		g2.setColor(new Color(150, 200, 0, 75));
