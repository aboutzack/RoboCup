 ...
 * @author CSU-zack
 */
@ViewLayer(visible = false, caption = "Allowed To Send Radio", tag = "AllowedToSendRadio", drawAllData = true)
public class CSUAllowedToSendRadioLayer extends MrlStandardHumanLayer {
