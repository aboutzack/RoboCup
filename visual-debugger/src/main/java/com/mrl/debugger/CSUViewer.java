...
import static com.mrl.debugger.CSUConstants.*;
import static rescuecore2.misc.java.JavaTools.instantiate;

/**
 * A simple viewer.
 */
public class CSUViewer extends StandardViewer{
    private static org.apache.log4j.Logger Logger = org.apache.log4j.Logger.getLogger(CSUViewer.class);
    ...
    public CSUViewer(boolean showInLaunch) {
    ...
    public void selectObject(Integer id) {
        ...
        propertiesTable.setValueAt(selectedObject.getProperty(CSUConstants.X_URN).getValue(), i++, 1);
        propertiesTable.setValueAt("y", i, 0);
        propertiesTable.setValueAt(selectedObject.getProperty(CSUConstants.Y_URN).getValue(), i++, 1);
...
//            }
            ...
            if (selectedObject instanceof Building) {
                ...
                propertiesTable.setValueAt(selectedObject.getProperty(BUILDING_AREA_GROUND_URN).getValue(), i++, 1);
                propertiesTable.setValueAt("totalarea", i, 0);
                propertiesTable.setValueAt(selectedObject.getProperty(BUILDING_AREA_TOTAL_URN).getValue(), i++, 1);
                propertiesTable.setValueAt("floors", i, 0);
                propertiesTable.setValueAt(selectedObject.getProperty(FLOORS_URN).getValue(), i++, 1);
                ...
                propertiesTable.setValueAt(selectedObject.getProperty(IGNITION_URN).getValue(), i++, 1);
                ...
                propertiesTable.setValueAt(selectedObject.getProperty(BROKENNESS_URN).getValue(), i++, 1);
                propertiesTable.setValueAt("edges", i, 0);
                propertiesTable.setValueAt(selectedObject.getProperty(EDGES_URN).getValue(), i++, 1);
...
//                }
                ...
                propertiesTable.setValueAt(selectedObject.getProperty(BLOCKADES_URN).getValue(), i++, 1);
                propertiesTable.setValueAt("edges", i, 0);
                propertiesTable.setValueAt(selectedObject.getProperty(EDGES_URN).getValue(), i++, 1);
...
//                }
            ...
            propertiesTable.setValueAt(selectedObject.getProperty(REPAIR_COST_URN).getValue(), i++, 1);
            propertiesTable.setValueAt("edges", i, 0);
            propertiesTable.setValueAt(selectedObject.getProperty(EDGES_URN).getValue(), i++, 1);
            propertiesTable.setValueAt("position", i, 0);
            propertiesTable.setValueAt(selectedObject.getProperty(POSITION_URN).getValue(), i++, 1);
            propertiesTable.setValueAt("apexes", i, 0);
            propertiesTable.setValueAt(selectedObject.getProperty(APEXES_URN).getValue(), i++, 1);
//            MrlBlocka mrlBlockade = new MrlBlockade(null, (Blockade) selectedObject, Util.getPolygon(((Blockade) selectedObject).getApexes()));
