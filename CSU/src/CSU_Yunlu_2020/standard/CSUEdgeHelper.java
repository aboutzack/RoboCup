...
public class CSUEdgeHelper {
	...
	// only for test
	public CSUEdgeHelper(Point2D start, Point2D end, boolean passable) {
	...
	public CSUEdgeHelper(WorldInfo world, Edge underlyingEdge, EntityID owner) {
