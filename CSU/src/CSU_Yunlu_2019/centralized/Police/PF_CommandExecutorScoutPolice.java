package CSU_Yunlu_2019.centralized.Police;
...
public class PF_CommandExecutorScoutPolice  extends CommandExecutor<CommandScout> {
	    ...
	    public PF_CommandExecutorScoutPolice(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
