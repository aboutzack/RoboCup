...
public class PF_CommandExecutorPolice extends CommandExecutor<CommandPolice> {
	    ...
	    public PF_CommandExecutorPolice(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
