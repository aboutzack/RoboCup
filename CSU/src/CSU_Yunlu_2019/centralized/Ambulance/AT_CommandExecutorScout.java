...
public class AT_CommandExecutorScout  extends CommandExecutor<CommandScout>{
	    ...
	    public AT_CommandExecutorScout(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
