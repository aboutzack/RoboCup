...
public class AT_CommandPickerAmbulance extends CommandPicker{
	    ...
	    public AT_CommandPickerAmbulance(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
