...
public class FB_CommandExecutorFire extends CommandExecutor<CommandFire> {
	    ...
	    public FB_CommandExecutorFire(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
