package CSU_Yunlu_2019.centralized.Fire;
...
public class FB_CommandExecutorScout extends CommandExecutor<CommandScout>{
	    ...
	    public FB_CommandExecutorScout(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
