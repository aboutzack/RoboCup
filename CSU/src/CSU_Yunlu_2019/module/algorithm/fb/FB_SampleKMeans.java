...
public class FB_SampleKMeans extends StaticClustering{
	...
	//import static java.util.Comparator.reverseOrder;
	    ...
	    public FB_SampleKMeans(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
