...
public class AT_SampleKMeans extends StaticClustering{
	...
	//import static java.util.Comparator.reverseOrder;
	    ...
	    public AT_SampleKMeans(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
