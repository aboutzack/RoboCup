...
public class AT_TestAmbulanceTargetAllocator  extends AmbulanceTargetAllocator {
	    ...
	    public AT_TestAmbulanceTargetAllocator(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
	            ...
	            if(message.getTargetID() != null) {
	                ...
	                if(entity != null) {
	                    if(entity instanceof Area) {
	                        ...
	                        return info;
	                    } else if(entity instanceof Human && info.target!=null) {
