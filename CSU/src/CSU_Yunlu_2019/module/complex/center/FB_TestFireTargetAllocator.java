...
public class FB_TestFireTargetAllocator extends FireTargetAllocator{
	    ...
	    public FB_TestFireTargetAllocator(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
