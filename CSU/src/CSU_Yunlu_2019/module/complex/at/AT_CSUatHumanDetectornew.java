...
public class AT_CSUatHumanDetectornew extends HumanDetector {
    ...
    public AT_CSUatHumanDetectornew(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
