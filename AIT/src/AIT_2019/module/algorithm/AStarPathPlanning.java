...
public class AStarPathPlanning extends PathPlanning
{
    ...
    @Override
    public List<EntityID> getResult() { return this.result; }
    ...
    public PathPlanning calc()
    {
        ...
        while (true)
        {
            ...
            for (EntityID neighbour : neighbours)
            {
                ...
                {
                    if(m.getCost() < nodeMap.get(neighbour).getCost())
                    {
                        nodeMap.put(neighbour, m);
                    }
                } else if(close.contains(neighbour) && m.estimate() == nodeMap.get(neighbour).estimate())
    ...
    private boolean isGoal(EntityID e, Collection<EntityID> test) { return test.contains(e); }
    ...
    private class Node
    {
        ...
        public double estimate(){ return cost+heuristic; }

        public EntityID getParent(){ return this.parent; }
    }
}
