...
public class AITActionTransport extends ExtAction
{
    ...
    public AITActionTransport(AgentInfo agentInfo, WorldInfo worldInfo, ScenarioInfo scenarioInfo, ModuleManager moduleManager, DevelopData developData)
    {
    ...
    {
//        System.out.println("🚑 ActionTransport AGENT(" + this.agentInfo.getID() + ") " + this.result);
		return this.result;
	}
    //  @ END OF DEBUG
    ...
    private Action calcRescue(AmbulanceTeam agent, PathPlanning pathPlanning, EntityID targetID)
    {
        ...
        if (targetEntity instanceof Human)
        {
            ...
            if ((agentPosition.getValue() == targetPosition.getValue()) && (targetEntity.getStandardURN() != StandardEntityURN.REFUGE))
            {
